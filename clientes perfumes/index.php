    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while( $pt = mysqli_fetch_object($data) ){
                ...
                echo"<a class= 'btn btn-info col-2 mx-auto fs-56' href='".ROOT."/clientes perfumes/edit.php?id=$pt->id'>Editar</a>-<a class ='btn btn-info col-2 mx-auto fs-6' href='".ROOT."/clientes perfumes/index.php?id=$pt->id'>Eliminar<a>";
                echo"</div>";
                echo"</div>";
                echo"</div>";
            }        
